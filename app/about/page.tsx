  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-12">
        ...
        <p className="mt-4 text-lg text-gray-600">
          The societal impact of MedMind Innovision &apos s projects is profound. By focusing on early detection of rare diseases and preventive healthcare measures, we aim to alleviate the burden on healthcare systems, improve patient outcomes, and foster a proactive approach to health management.
        </p>
      </div>
      <div className="mt-12">
